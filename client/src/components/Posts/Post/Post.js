...
const Post = ({ post, setCurrentId }) => {
    ...
    return (
        ...
        ></ButtonBase>
            ...
            <Typography className={classes.title} fontFamily='Arial' variant="h6" gutterBottom>Profession: {post.profession}</Typography>
            <Typography className={classes.title} variant="subtitle1" gutterBottom>Mobile: {post.contact}</Typography>
            <Typography className={classes.title} variant="subtitle1" gutterBottom>Experience: {post.experience} years</Typography>
